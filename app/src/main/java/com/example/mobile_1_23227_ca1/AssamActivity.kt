...
import kotlinx.android.synthetic.main.activity_assam.*
        ...
        addToCart.setOnClickListener{
            if(count > 0) {
                ...
                val db = Room.databaseBuilder(
                    ...
                    .build()
                db.cartDao().insertCart(Cart_Entity(cart_item_name = getString(R.string.Assam), cart_item_price=price, cart_item_number = count))

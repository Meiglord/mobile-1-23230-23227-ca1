...
import kotlinx.android.synthetic.main.activity_lapsang.*

class LapsangActivity : AppCompatActivity() {

    var count = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_lapsang)
        ...
        addToCart.setOnClickListener{
            if(count > 0) {
                ...
                val db = Room.databaseBuilder(
                    ...
                    .build()
                db.cartDao().insertCart(Cart_Entity(cart_item_name = getString(R.string.Lapsang), cart_item_price=price, cart_item_number = count))
